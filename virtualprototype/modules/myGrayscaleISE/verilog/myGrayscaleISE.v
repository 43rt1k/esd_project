...
//   The custom instruction is activated when the input `iseId` matches the parameter
//   `customInstructionId` and the `start` signal is high.
module myGrayscaleISE #(  parameter [7:0] customInstructionId = 8'h0C )
                        ( input wire         start,    // Signal indicating custom instruction activation
                          ...
                          input wire [7:0]   iseId,    // Custom instruction ID from the CPU
  ...
  wire s_isMyIse = (iseId == customInstructionId) ? start : `FALSE;
  ...
  */
  _myGrayscale1pixelCI pixel1 ( .rgb565({ valueA[`P1_L+7:`P1_L], valueA[`P1_H:`P1_L+8] }),
                                .grayscale(s_grayScaleValues[`G3_H:`G3_L]));

  _myGrayscale1pixelCI pixel2 ( .rgb565({ valueA[`P2_L+7:`P2_L], valueA[`P2_H:`P2_L+8] }),
                                .grayscale(s_grayScaleValues[`G4_H:`G4_L]));

  _myGrayscale1pixelCI pixel3 ( .rgb565({ valueB[`P3_L+7:`P3_L], valueB[`P3_H:`P3_L+8] }),
                                .grayscale(s_grayScaleValues[`G1_H:`G1_L]));

  _myGrayscale1pixelCI pixel4 ( .rgb565({ valueB[`P4_L+7:`P4_L], valueB[`P4_H:`P4_L+8] }),
                                .grayscale(s_grayScaleValues[`G2_H:`G2_L]));
